export const translations = {
  en: {
    ...
    requirements: {
      ...
      subtitle: "Licensing Requirements for Private Security Agencies",
      mandatory: "Mandatory",
    ...
    settings: {
      ...
      security: {
        ...
        optionalAgency: "Optional for Agencies",
        disabled: "Disabled",
      ...
      notifications: {
        ...
        desc: "Control how the system communicates with agencies, applicants, and regional blocks.",
    ...
    hrmsReports: {
      ...
      subtitle: "Reports retrieved from individual agency HRMS systems",
  ...
  am: {
    ...
    hero: {
      ...
      titleLine1: "የፌዴራል ፖሊስ የግል ደህንነት",
      titleLine2: "ኤጀንሲ ፈቃድ",
    ...
    trust: {
      ...
      desc: "የፌዴራል ፖሊስ የደህንነት ኤጀንሲዎችን ደረጃ በማሳደግ የሃገራችንን ሰላም እና ደህንነት በጋራ ያረጋግጣል።",
    ...
    requirements: {
      title: "አጠቃላይ መስፈርቶች",
      subtitle: "የግል ደህንነት ኤጀንሲ ለመክፈት የሚያስፈልጉ መስፈርቶች",
      mandatory: "ግዴታ",
      notice: "አስፈላጊ ማሳሰቢያ",
      ...
      sections: [
        {
          ...
          items: [
            ...
            "የደንብ ልብስ ናሙና (በፎቶ)",
            "የኤጀንሲው የሰራተኛ መታወቂያ ናሙና (ፊት እና ጀርባ በፎቶ)",
            "የቅጥር ቅጽ (በፎቶ)",
            "የቅጥር ዋስትና ቅጽ (በፎቶ)",
            "የድርጅቱ አርማ (በፎቶ)",
    ...
    settings: {
      ...
      notifications: {
        ...
        desc: "ስርዓቱ ከኤጀንሲዎች፣ አመልካቾች እና የክልል ብሎኮች ጋር እንዴት እንደሚገናኝ ይቆጣጠሩ።",
        critical: "ወሳኝ የስርዓት ማንቂያዎች",
        pushEmail: "ፑሽ፣ ኢሜል",
        agencyReminders: "የኤጀንሲ ፈቃድ ማሳሰቢያዎች",
        sms: "ኤስኤምኤስ (SMS)",
    ...
    hrmsReports: {
      title: "የኤጀንሲዎች HRMS ሪፖርቶች",
      subtitle: "ከኤጀንሲዎች የሰው ኃይል አስተዳደር ስርዓት የተገኙ ሪፖርቶች",
      search: "ኤጀንሲ ይፈልጉ...",
      exportAll: "ሁሉንም አውርድ",
