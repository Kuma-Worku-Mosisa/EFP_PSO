...
export const Notifications = () => {
    ...
    if (user?.role === 'agency') {
      return [
        { 
          ...
          message: isAm ? 'የእርስዎ የንግድ ፈቃድ በ30 ቀናት ውስጥ ይቆያል። እባክዎን ቀድመው ያድሱ።' : 'Your operating license expires in 30 days. Please renew early to avoid service interruption.', 
          time: '2h ago', 
          read: false, 
          type: 'warning',
          category: 'license'
        ...
        { 
          ...
          message: isAm ? 'ለአዲስ ቅርንጫፍ ያቀረቡት ማመልከቻ በፌዴራል ፖሊስ ተቀባይነት አግኝቷል።' : 'Your application for a new branch office has been formally approved by the Federal Police.', 
          time: '5h ago', 
          read: false, 
          type: 'success',
        ...
        { 
          ...
          message: isAm ? 'በአስተዳዳሪው በኩል በገባው የሰው ኃይል ሪፖርት ላይ አስተያየት ተሰጥቷል - "እባክዎን ተጨማሪ መረጃ ይጨምሩ"' : 'Admin left a comment on your HR report: "Please provide more details on the training certifications."', 
          time: '1d ago', 
          read: true, 
          type: 'message',
          category: 'system'
        ...
        { 
          ...
          message: isAm ? 'የፈቃድ እድሳት ጥያቄዎ አስፈላጊ ሰነዶች በመጉደላቸው ምክንያት ውድቅ ተደርጓል።' : 'Your renewal request was rejected due to missing technical evaluation documents.', 
          time: '2d ago', 
          read: true, 
          type: 'error',
          category: 'license'
      ...
      return [
        { 
          ...
          message: isAm ? '"አቢሲኒያ ሴኩሪቲ" አዲስ ተመዝግቦ የፈቃድ መጠባበቅ ላይ ነው።' : '"Abyssinia Security" just registered and is awaiting initial verification.', 
          time: '5m ago', 
          read: false, 
          type: 'info',
          category: 'user'
        ...
        { 
          ...
          message: isAm ? '"አንበሳ ጥበቃ" አዲስ ይፋዊ ደብዳቤ አስገብቷል።' : 'Lion Guard Services has submitted a new formal communication letter.', 
          time: '1h ago', 
          read: false, 
          type: 'info',
          category: 'application'
        ...
        { 
          ...
          message: isAm ? 'አዲስ የደህንነት ኤጀንሲ ፈቃድ ማመልከቻ ገብቷል።' : 'A new specialized security agency application has been submitted for review.', 
          time: '3h ago', 
          read: false, 
          type: 'info',
          category: 'application'
        ...
        { 
          ...
          message: isAm ? 'ከ"ናይል ፕሮቴክሽን" የሰራተኛ የወንጀል ሪፖርት ተልኳል።' : 'A criminal record alert regarding a dismissed personnel was reported by Nile Protection.', 
          time: '6h ago', 
          read: false, 
          type: 'error',
          category: 'report'
        ...
        { 
          ...
          message: isAm ? 'ከ"ኢግል አይ" ሳምንታዊ የሰው ኃይል ሁኔታ ሪፖርት ደርሷል።' : 'Eagle Eye Security has pushed their weekly HRMS synchronization report.', 
          time: '1d ago', 
          read: true, 
          type: 'message',
          category: 'report'
  ...
  const getIcon = (type: Notification['type'], category: Notification['category']) => {
    if (category === 'report' && type === 'error') return <ShieldAlert className="text-red-500" />;
    if (category === 'report') return <FileText className="text-blue-500" />;
    if (category === 'license') return <RefreshCw className="text-amber-500" />;
    if (category === 'application') return <FilePlus className="text-green-500" />;
    ...
    switch (type) {
      ...
      case 'error': return <Trash2 className="text-red-500" />;
      case 'message': return <MessageSquare className="text-primary" />;
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">
                {isAm ? 'የቅርብ ጊዜ ዝመናዎችን እና ማንቂያዎችን ይከታተሉ' : 'Stay updated with your latest alerts and activities'}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-[40px] border border-gray-100 shadow-xl overflow-hidden min-h-[600px] flex flex-col">
        <div className="p-8 border-b border-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-gray-50/30">
          <div className="flex p-1 bg-gray-100 rounded-2xl w-fit">
            <button
              ...
              className={cn(
                ...
                activeTab === 'all' ? "bg-white text-primary shadow-sm" : "text-gray-400 hover:text-primary"
              )}
            >
              {isAm ? 'ሁሉም' : 'All'}
            </button>
            <button
              ...
              className={cn(
                ...
                activeTab === 'unread' ? "bg-white text-primary shadow-sm" : "text-gray-400 hover:text-primary"
              )}
            >
          ...
          <div className="relative">
            ...
            <input 
              type="text" 
              placeholder={isAm ? "ማሳወቂያዎችን ይፈልጉ..." : "Search notifications..."}
              value={searchTerm}
                ...
                {filteredNotifications.map((n, i) => (
                  ...
                  >
                    ...
                    <div className={cn(
                      ...
                      n.read ? "bg-white border-gray-100" : "bg-white border-primary/20 ring-4 ring-primary/5"
                    )}>
                    ...
                    <div className="flex-grow space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          <h3 className={cn(
                            ...
                            n.read ? "font-bold text-gray-600" : "font-black text-primary"
                          )}>
                            {n.title}
                          </h3>
                          <span className={cn(
                            "text-[9px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border",
                            n.category === 'license' ? "bg-amber-50 text-amber-600 border-amber-100" :
                            n.category === 'application' ? "bg-green-50 text-green-600 border-green-100" :
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            >
                              {n.read ? <Mail className="w-4 h-4" /> : <CheckCheck className="w-4 h-4" />}
                            </button>
                            <button 
                      ...
                      <p className={cn(
                        ...
                        n.read ? "text-gray-400 font-medium" : "text-gray-500 font-bold"
                      )}>
                        {n.message}
                      </p>
                    </div>
              ...
              <div className="flex flex-col items-center justify-center py-32 space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">
                    {searchTerm ? (isAm ? 'ፍለጋዎን ይቀይሩ' : 'Try adjusting your search') : (isAm ? 'ሁሉንም አጽድተዋል' : 'You are all caught up!')}
                  </p>
                </div>
              </div>
            )}
        ...
        <div className="p-8 border-t border-gray-50 bg-gray-50/30 flex justify-between items-center">
          <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">
            {isAm ? 'ከፌዴራል ፖሊስ ማሳወቂያዎች' : 'Official Communications from Federal Police'}
          </p>
          <div className="flex items-center space-x-2">
            <div className="h-2 w-2 bg-green-500 rounded-full animate-pulse" />
            <span className="text-[10px] font-black text-green-600 uppercase tracking-widest">{isAm ? 'ቀጥታ ስርጭት' : 'Real-time active'}</span>
          </div>
        </div>
      </div>
    </div>
