...
import { Shield, ArrowRight, Download, PhoneCall, Mail, CheckCircle, Newspaper, Globe, Sparkles, Zap, X, Calendar, User, Tag } from 'lucide-react';
...
export const Home = () => {
  ...
  const news = [
    {
      date: isAm ? "ሚያዝያ 12, 2016" : "April 20, 2024",
      title: isAm ? "አዲስ የደንብ ልብስ መመሪያ ወጥቷል" : "New Uniform Guidelines Released",
      desc: isAm ? "ሁሉም የግል ደህንነት ኤጀንሲዎች እንዲከተሏቸው የሚገቡ አዳዲስ የደንብ ልብስ ደረጃዎች ይፋ ሆነዋል።" : "The Federal Police has released updated standards for private security agency uniforms and markings.",
      tag: isAm ? "መመሪያ" : "Directive",
      image: `https://picsum.photos/seed/news1/800/600`
    },
    {
      date: isAm ? "ሚያዝያ 10, 2016" : "April 18, 2024",
      title: isAm ? "የዲጂታል ፈቃድ አሰጣጥ ስልጠና" : "Digital Licensing Workshop",
      desc: isAm ? "ለኤጀንሲ ባለቤቶች ስለ አዲሱ ዲጂታል ፖርታል አጠቃቀም የግንዛቤ ማስጨበጫ ስልጠና ተሰጥቷል።" : "Workshop conducted for agency owners on the new automated licensing and personnel vetting portal.",
      tag: isAm ? "ስልጠና" : "Workshop",
      image: `https://picsum.photos/seed/news2/800/600`
    },
    {
      date: isAm ? "ሚያዝያ 08, 2016" : "April 16, 2024",
      title: isAm ? "የፋይዳ መታወቂያ አስገዳጅነት" : "Mandatory Fayda ID Enforcement",
      desc: isAm ? "ከግንቦት 1 ጀምሮ ያለ ፋይዳ መታወቂያ ማንኛውንም የፈቃድ አገልግሎት ማግኘት እንደማይቻል ተገልጿል።" : "Full enforcement of Fayda ID requirement for all security personnel starts next month.",
      tag: isAm ? "ማስታወቂያ" : "Notice",
    ...
    <div className="space-y-32 pb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-secondary font-bold text-sm tracking-widest uppercase">{t.hero.badge}</span>
              </motion.div>
              
              <h1 className="font-extrabold tracking-tight text-center lg:text-left">
                <span className="block text-4xl md:text-[60px] md:leading-[72px] font-sans">{t.hero.titleLine1}</span>
                <span className="block text-secondary text-3xl md:text-[52px]">{t.hero.titleLine2}</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
                <Link to="/register" className="gold-gradient text-primary px-10 py-5 rounded-2xl font-bold text-lg flex items-center justify-center space-x-3 hover:shadow-2xl hover:scale-105 transition-all group">
                  <span>{t.hero.applyNow}</span>
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </Link>
                <Link to="/login" className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-10 py-5 rounded-2xl font-bold text-lg flex items-center justify-center hover:bg-white/20 transition-all">
                  {t.hero.login}
                </Link>
              </div>
            </motion.div>
              ...
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 p-12 rounded-[40px] shadow-2xl overflow-hidden group">
                ...
                <div className="relative z-10 space-y-8">
                  <div className="flex items-center justify-between border-b border-white/10 pb-6">
                    ...
                    <span className="text-secondary font-black uppercase tracking-widest text-xs">{t.hero.trackStatus}</span>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm group-hover:bg-white/10 transition-all">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <p className="text-white font-black text-lg uppercase tracking-tight">{t.hero.card.commandCenter}</p>
                          <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-0.5">{t.hero.card.securityOversight}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-6 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm group-hover:bg-white/10 transition-all delay-75">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <p className="text-white font-black text-lg uppercase tracking-tight">{t.hero.card.realTimeLicensing}</p>
                          <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-0.5">{t.hero.card.complianceGrid}</p>
                        </div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          ...
          <Link to="/services" className="text-primary font-black uppercase text-xs tracking-widest flex items-center space-x-2 group">
            <span>{t.services.newsArchive}</span>
            ...
            >
              <div className="h-48 relative overflow-hidden bg-gray-50 group-hover:bg-gray-100 transition-colors duration-700">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <Newspaper className="w-12 h-12 text-primary/5 group-hover:scale-110 group-hover:text-primary/10 transition-all duration-700" />
                </div>
                <div className="absolute top-4 right-4">
                  <span className="bg-white/90 backdrop-blur-md text-primary px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest shadow-sm">{item.tag}</span>
                </div>
              </div>
              <div className="p-8">
                <span className="text-[10px] font-black text-primary/40 uppercase tracking-widest block mb-4">{item.date}</span>
                <h4 className="text-xl font-black text-primary mb-4 uppercase tracking-tight group-hover:text-accent transition-colors">{item.title}</h4>
                <p className="text-sm text-gray-500 font-medium leading-relaxed italic line-clamp-2 mb-8">{item.desc}</p>
                <button 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              ...
              >
                ...
                />
                <span className="text-primary font-black text-[10px] tracking-[0.3em] uppercase">{t.trust.badge}</span>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-primary font-black uppercase text-sm tracking-widest">{t.trust.networkTitle}</h4>
                    <p className="text-gray-500 text-xs font-semibold italic leading-relaxed">{t.trust.networkDesc}</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    <h4 className="text-white font-black uppercase text-sm tracking-widest">{t.trust.digitalTitle}</h4>
                    <p className="text-gray-300/80 text-xs font-semibold italic leading-relaxed">{t.trust.digitalDesc}</p>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative h-full w-full bg-white border border-gray-100 rounded-[80px] p-6 group overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)]">
                <div className="relative h-full w-full bg-gray-50 border border-gray-100 rounded-[60px] p-12 flex flex-col justify-center items-center text-center space-y-12 group overflow-hidden">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-4xl font-black text-primary uppercase tracking-tighter">{t.trust.alpha}</h4>
      ...
      <section className="bg-dark-blue py-24 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            <h2 className="text-secondary font-bold tracking-widest uppercase text-sm">{t.fayda.badge}</h2>
            <h3 className="text-4xl md:text-5xl font-bold text-white leading-tight">{t.fayda.title}</h3>
            <p className="text-gray-300 text-lg leading-relaxed">
              {t.fayda.desc}
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
              {t.fayda.features.map((item: string, i: number) => (
                <div key={i} className="bg-white/10 backdrop-blur-sm p-4 rounded-2xl border border-white/10 flex flex-col items-center space-y-2">
            ...
            <div className="pt-8">
              <Link to="/register" className="gold-gradient text-primary px-8 py-4 rounded-xl font-bold inline-flex items-center space-x-2 hover:shadow-lg transition-all">
                <span>{t.hero.applyNow}</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gray-50 rounded-[64px] p-12 md:p-20 relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h3 className="text-4xl font-black text-primary uppercase tracking-tighter">{t.rules.title}</h3>
              <p className="text-gray-500 font-medium text-lg leading-relaxed italic max-w-lg">
                {isAm ? "ሁሉንም የፌዴራል ፖሊስ ደንቦች እና መመሪያዎች እዚህ ያግኙ። እነዚህም ሰነዶች ለኤጀንሲዎች ስራ መሰረት ናቸው።" : "Access the complete library of federal security mandates and procedural frameworks required for operational legitimacy."}
              </p>
              <Link to="/services" className="inline-flex items-center space-x-2 text-primary font-black uppercase text-xs tracking-widest group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {t.rules.items.map((doc: any, i: number) => (
                <div key={i} className="flex flex-col justify-between p-6 bg-white rounded-3xl hover:shadow-xl transition-all border border-transparent hover:border-secondary group h-full">
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="font-black text-primary uppercase tracking-tight leading-none mb-2">{doc.title}</p>
                      <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest">{doc.size} • {t.rules.pdfFormat}</p>
                    </div>
                  </div>
                  <a href="#" className="mt-6 text-accent hover:text-primary transition-colors flex items-center space-x-2 text-[10px] font-black uppercase tracking-widest">
        ...
        <div className="bg-gray-900 rounded-[40px] p-8 md:p-16 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-gray-400 text-lg">{t.footer.desc}</p>
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  <div className="p-4 bg-white/10 rounded-2xl"><PhoneCall className="text-secondary" /></div>
                  <div>
                    <p className="text-sm text-gray-500">{t.contact.info.phone.title}</p>
                    <p className="text-xl font-bold">{t.contact.info.phone.val}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="p-4 bg-white/10 rounded-2xl"><Mail className="text-secondary" /></div>
                  <div>
                    <p className="text-sm text-gray-500">{t.contact.info.email.title}</p>
                    <p className="text-xl font-bold">{t.contact.info.email.val}</p>
                  </div>
                </div>
              </div>
            </div>
            <form className="bg-white/5 p-8 rounded-3xl backdrop-blur-md border border-white/10 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input type="text" placeholder={t.contact.form.placeholder.name} className="bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder:text-gray-500 focus:outline-none focus:border-secondary" />
                <input type="email" placeholder={t.contact.form.placeholder.email} className="bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder:text-gray-500 focus:outline-none focus:border-secondary" />
              </div>
              <input type="text" placeholder={t.contact.form.placeholder.subject} className="w-full bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder:text-gray-500 focus:outline-none focus:border-secondary" />
              <textarea placeholder={t.contact.form.placeholder.message} rows={4} className="w-full bg-white/10 border border-white/20 rounded-xl p-4 text-white placeholder:text-gray-500 focus:outline-none focus:border-secondary" />
              <button className="w-full gold-gradient text-primary font-bold py-4 rounded-xl hover:shadow-lg transition-all">{t.contact.form.submit}</button>
            </form>
          </div>
        </div>
      </section>
