    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex justify-between items-center no-print">
        ...
        <div className="flex space-x-3">
          <button 
            onClick={handlePrint}
            className="flex items-center space-x-2 px-6 py-3 bg-white border rounded-xl font-bold text-gray-600 hover:bg-gray-50 transition-all"
          >
      ...
      <div className="bg-white p-8 md:p-16 rounded-sm shadow-2xl border-[16px] border-double border-secondary/30 relative print:shadow-none print:border-secondary/40 mx-auto aspect-[1/1.414] w-full max-w-[800px]">
        {/* Ornate Border Overlay */}
        <div className="absolute inset-4 border-2 border-secondary/10 pointer-events-none" />
        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="flex flex-col items-center">
              <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center p-1 border-4 border-secondary/20 shadow-sm">
                <img 
            ...
            <div className="w-20 h-20 border-2 border-dashed border-secondary/30 rounded-xl flex flex-col items-center justify-center bg-secondary/5 text-secondary/40 p-2 text-center mt-2">
            ...
            <div className="w-28 h-36 border-2 border-dashed border-secondary/30 rounded-lg flex flex-col items-center justify-center bg-secondary/5 text-secondary/40 p-2 text-center">
          ...
          <div className="text-center space-y-3 mb-8">
            <div className="space-y-1">
              ...
              <h4 className="text-base font-bold text-primary/80 uppercase tracking-wider">The Federal Democratic Republic of Ethiopia Federal police</h4>
            </div>
            
            <div className="py-3 border-y-2 border-secondary/20">
              <h5 className="text-xl font-black text-primary mb-1">የግል የጥበቃ ተቋማት የብቃት ማረጋገጫ የምስክር ወረቀት</h5>
              <h5 className="text-lg font-bold text-secondary italic font-serif">Private Security Agencies Quality Assurance Certificate</h5>
            </div>
          </div>
          ...
          <div className="flex-1 space-y-6 text-left px-4">
            <div className="grid grid-cols-1 gap-4">
              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">የተቋሙ ስም / Name of the Agency:</span>
                <span className="text-lg font-black text-primary uppercase">Abyssinia Security Services PLC</span>
              </div>

              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">አድራሻ / Address:</span>
                <span className="text-base font-bold text-primary">Addis Ababa, Bole Sub-City, Woreda 03, House No. 123</span>
              </div>

              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">የብቃት ደረጃ / Level:</span>
                <span className="text-base font-bold text-primary">LEVEL - ONE (1)</span>
              </div>

              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">የተሰጠበት ቀን / Date of Issued:</span>
                <span className="text-base font-bold text-primary">22/09/2025</span>
              </div>

              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">የሚያበቃበት ቀን / Date of Expired:</span>
                <span className="text-base font-bold text-primary">21/09/2026</span>
              </div>

              <div className="flex items-baseline space-x-4 border-b border-secondary/10 pb-1">
                <span className="text-xs font-bold text-gray-500 w-40 shrink-0">የፈቃድ ቁጥር / License No:</span>
                <span className="text-lg font-black text-secondary tracking-widest">FP-PSA-2025-0892</span>
              </div>
            </div>
          ...
          <div className="mt-auto pt-8 flex justify-between items-end">
            ...
            <div className="space-y-3">
              <div className="w-48 h-24 border-b-2 border-secondary/30 relative flex items-center justify-center">
                {/* Stamp Placeholder */}
                <div className="absolute -top-4 -right-4 w-20 h-20 border-4 border-secondary/30 rounded-full flex items-center justify-center rotate-12 pointer-events-none">
                  <div className="text-[7px] font-bold text-secondary/40 text-center uppercase">
                    Federal Police<br/>Commission<br/>STAMP
                  </div>
                </div>
                <span className="text-gray-300 font-serif italic text-xs">Commissioner's Signature</span>
              </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none select-none">
          <Shield className="w-[600px] h-[600px] text-secondary" />
        </div>
      </div>
